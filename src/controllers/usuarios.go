...
// * BuscarUsuario - Busca um único usuário no banco.
...
// * AtualizaUsuario - Atualiza um único usuário no banco.
...
// * ExcluirUsuario - Excluí um único usuário no banco.
